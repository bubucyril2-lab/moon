...
import { Landmark, LogIn, UserPlus, LogOut, LayoutDashboard, User, Menu, X, Languages, ArrowRight } from 'lucide-react';
          ...
          <div className="flex-1 overflow-y-auto no-scrollbar p-8 space-y-10">
            {!isAuthenticated ? (
              ...
              <>
                ...
                <div className="space-y-4">
                  <p className="text-[10px] font-black text-zinc-400 uppercase tracking-[0.2em] ml-4">Management</p>
                  <div className="grid gap-2">
                    <Link to={isAdmin ? "/admin" : "/dashboard"} className="px-6 py-5 text-lg font-black text-zinc-900 hover:bg-zinc-50 rounded-2xl transition-all flex items-center gap-4 group">
                    ...
                    <button onClick={logout} className="px-6 py-5 text-lg font-black text-red-600 hover:bg-red-50 rounded-2xl transition-all flex items-center gap-4 w-full text-left group">
